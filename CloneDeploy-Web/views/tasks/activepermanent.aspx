<%@ Page Title="" Language="C#" MasterPageFile="~/views/tasks/task.master" AutoEventWireup="true" Inherits="views_tasks_activepermanent" Codebehind="activepermanent.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Help" Runat="Server">
    ...
    <li><a href="<%= ResolveUrl("~/views/help/tasks-activepermanent.aspx")%>"  target="_blank">Help</a></li>
</asp:Content>
