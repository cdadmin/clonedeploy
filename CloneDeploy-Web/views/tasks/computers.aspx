<%@ Page Title="" Language="C#" MasterPageFile="~/views/tasks/task.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.tasks.TaskUnicast" Codebehind="computers.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Help" Runat="Server">
    ...
    <li>
        <a href="<%= ResolveUrl("~/views/help/tasks-startcomputer.aspx") %>" target="_blank">Help</a>
    </li>
</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="AdditionalActions">
    <li>
        <asp:LinkButton ID="btnListPermanentDeploy" runat="server" OnClick="btnListPermanentDeploy_Click" Text="Permanent Deploy Selected"></asp:LinkButton>
    </li>
    <li>
        <asp:LinkButton ID="btnListUpload" runat="server" OnClick="btnListUpload_Click" Text="Upload Selected"></asp:LinkButton>
    </li>
</asp:Content>
