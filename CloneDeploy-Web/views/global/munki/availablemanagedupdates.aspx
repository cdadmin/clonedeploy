<%@ Page Title="" Language="C#" MasterPageFile="~/views/global/munki/munki.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.global.munki.views_global_munki_availablemanagedupdates" Codebehind="availablemanagedupdates.aspx.cs" %>
...
<asp:Content runat="server" ID="TopNav" ContentPlaceHolderID="SubPageNavSub">
    <li id="assigned">
        <a href="<%= ResolveUrl("~/views/global/munki/assignedmanagedupdates.aspx") %>?manifestid=<%= ManifestTemplate.Id %>&cat=sub2">
            <span class="sub-nav-text">Assigned Managed Updates</span></a>
    </li>
    <li id="available">
        <a href="<%= ResolveUrl("~/views/global/munki/availablemanagedupdates.aspx") %>?manifestid=<%= ManifestTemplate.Id %>&cat=sub2">
            <span class="sub-nav-text">Available Managed Updates</span></a>
    </li>
</asp:Content>
