    ...
    public partial class views_global_munki_assignedmanifests : Global
    {
        ...
        protected void PopulateGrid()
        {
            ...
            var templateInstalls =
                Call.MunkiManifestTemplateApi.GetManifestIncludedManifests(ManifestTemplate.Id)
            ...
            lblTotalAssigned.Text = gvTemplateInstalls.Rows.Count + " Result(s) / " +
                                    Call.MunkiManifestTemplateApi.GetIncludedManifestCount(ManifestTemplate.Id) +
                                    " Total Included Manifest(s)";
        }
