<%@ Page Title="" Language="C#" MasterPageFile="~/views/global/munki/munki.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.global.munki.views_global_munki_availablemanagedinstalls" Codebehind="availablemanagedinstalls.aspx.cs" %>
...
<asp:Content runat="server" ID="TopNav" ContentPlaceHolderID="SubPageNavSub">
    <li id="assignedmanagedinstalls">
        <a href="<%= ResolveUrl("~/views/global/munki/assignedmanagedinstalls.aspx") %>?manifestid=<%= ManifestTemplate.Id %>&cat=sub2">
            <span class="sub-nav-text">Assigned Managed Installs</span></a>
    </li>
    <li id="availablemanagedinstalls">
        <a href="<%= ResolveUrl("~/views/global/munki/availablemanagedinstalls.aspx") %>?manifestid=<%= ManifestTemplate.Id %>&cat=sub2">
            <span class="sub-nav-text">Available Managed Installs</span></a>
    </li>
</asp:Content>
