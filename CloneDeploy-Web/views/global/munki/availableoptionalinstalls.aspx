<%@ Page Title="" Language="C#" MasterPageFile="~/views/global/munki/munki.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.global.munki.views_global_munki_availableoptionalinstalls" Codebehind="availableoptionalinstalls.aspx.cs" %>
...
<asp:Content runat="server" ID="TopNav" ContentPlaceHolderID="SubPageNavSub">
    ...
    <li id="availableoptionalinstalls">
