<%@ Page Title="" Language="C#" MasterPageFile="~/views/global/filesandfolders/filesandfolders.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.global.filesandfolders.views_global_filesandfolders_search" Codebehind="search.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubHelp" Runat="Server">
    ...
    <li>
        <a href="<%= ResolveUrl("~/views/help/global-files.aspx") %>" target="_blank">Help</a>
    </li>
</asp:Content>
