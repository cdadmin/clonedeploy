<%@ Page Title="" Language="C#" MasterPageFile="~/views/computers/computers.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.computers.views_computers_groups" Codebehind="groups.aspx.cs" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Help">
    ...
    <li>
        <a href="<%= ResolveUrl("~/views/help/computers-group.aspx") %>" class="" target="_blank">Help</a>
    </li>
</asp:Content>
