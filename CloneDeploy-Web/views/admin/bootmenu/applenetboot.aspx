<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/bootmenu/bootmenu.master" AutoEventWireup="true" Inherits="views_admin_bootmenu_applenetboot" Codebehind="applenetboot.aspx.cs" %>
