<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/dp/dp.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.admin.dp.views_admin_dp_edit" Codebehind="edit.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent2" Runat="Server">
    ...
    <div class="size-5 column">
        <asp:TextBox ID="txtRwPassword" runat="server" CssClass="textbox password" TextMode="Password"/>
    </div>
    ...
    <div class="size-5 column">
        <asp:TextBox ID="txtRoPassword" runat="server" CssClass="textbox password" TextMode="Password"/>
    </div>
