<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/netboot/netboot.master" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="CloneDeploy_Web.views.admin.netboot.search" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ActionsRightSub">
    <a class="confirm btn btn-default" href="#">Delete Selected NetBoot Profiles</a>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent2" Runat="Server">
    ...
    <div id="confirmbox" class="confirm-box-outer">
        <div class="confirm-box-inner">
            <h4>
                <asp:Label ID="lblTitle" runat="server" Text="Delete The Selected NetBoot Profiles?"></asp:Label>
            </h4>
