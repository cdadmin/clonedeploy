<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/netboot/netboot.master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="CloneDeploy_Web.views.admin.netboot.edit" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ActionsRightSub">
    <asp:LinkButton ID="buttonUpdateProfile" runat="server" OnClick="buttonUpdateProfile_OnClick" Text="Update NetBoot Profile " CssClass="btn btn-default"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent2" Runat="Server">
    ...
    <br class="clear"/>
    <h4>Instructions:</h4>
    <asp:Label runat="server" ID="directions">
    </asp:Label>
    <h4>Vendor String:</h4>
    <asp:Label runat="server" Id="vendorString"></asp:Label>
