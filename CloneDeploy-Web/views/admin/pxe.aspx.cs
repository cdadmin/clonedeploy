...
namespace CloneDeploy_Web.views.admin
{
    public partial class views_admin_pxe : Admin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ddlPXEMode.SelectedValue = GetSetting(SettingStrings.PxeMode);
            ddlProxyDHCP.SelectedValue = GetSetting(SettingStrings.ProxyDhcp);
            ddlProxyBios.SelectedValue = GetSetting(SettingStrings.ProxyBiosFile);
            ddlProxyEfi32.SelectedValue = GetSetting(SettingStrings.ProxyEfi32File);
            ddlProxyEfi64.SelectedValue = GetSetting(SettingStrings.ProxyEfi64File);
