<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/logs/logs.master" AutoEventWireup="true" CodeBehind="frontend.aspx.cs" Inherits="CloneDeploy_Web.views.admin.logs.frontend" %>
<asp:Content ID="Content1" ContentPlaceHolderID="BreadcrumbSub2" Runat="Server">
    <li>Front End Logs</li>
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="SubHelp" Runat="Server">
     <li role="separator" class="divider"></li>
    <li><a href="<%= ResolveUrl("~/views/help/admin-logs.aspx") %>"   target="_blank">Help</a></li>
</asp:Content>
