<%@ Page Title="" Language="C#" MasterPageFile="~/views/images/profiles/profiles.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.images.profiles.views_images_profiles_Default" Codebehind="multicast.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubHelp" Runat="Server">
    ...
    <li>
        <a href="<%= ResolveUrl("~/views/help/images-multicastoptions.aspx") %>" target="_blank">Help</a>
    </li>
</asp:Content>
