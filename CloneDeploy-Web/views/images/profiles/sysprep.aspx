<%@ Page Title="" Language="C#" MasterPageFile="~/views/images/profiles/profiles.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.images.profiles.views_images_profiles_sysprep" Codebehind="sysprep.aspx.cs" %>
...
<asp:Content runat="server" ContentPlaceHolderID="SubHelp">
    ...
    <li>
        <a href="<%= ResolveUrl("~/views/help/images-sysprep.aspx") %>" target="_blank">Help</a>
    </li>
</asp:Content>
