<%@ Page Title="" Language="C#" MasterPageFile="~/views/images/profiles/profiles.master" AutoEventWireup="true" Inherits="views_images_profiles_task" Codebehind="task.aspx.cs" %>
...
<asp:Content runat="server" ContentPlaceHolderID="SubHelp">
    <li role="separator" class="divider"></li>
     <li><a href="<%= ResolveUrl("~/views/help/images-taskoptions.aspx")%>"  target="_blank">Help</a></li>
</asp:Content>
