...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <h1>Admin->PXE</h1>
   <p>The pxe settings control which bootloader is globally applied to computers when pxe booting.  If you are booting a mix of legacy bios and EFI computers, it is recommended to use 
