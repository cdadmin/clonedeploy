...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <p>
        Allows a user to start computer tasks such as deploy, upload or permanent deploy. A permanent deploy is a task that never closes. Every time that computer is pxe booted it will be re-imaged.
