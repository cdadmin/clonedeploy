...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <p>
        If a web task is cancelled from the web interface, the task will disappear, but will continue to run on the client itself.
        ...
        and upload any part of the log it currently has. This must be enabled before a task is started to work.
    </p>
