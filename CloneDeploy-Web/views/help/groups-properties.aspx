...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <p>
        Allows you to set the properties of all the computers in your group to a specific value. Any field that is checked when you click Update will update all computers
        ...
        the values selected to any new computers added to the group.
    </p>
</asp:Content>