...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <p>
        These settings are globally applied to all multicasts. Arguments can be specified to both the server and client to try and tweak the multicast. Each multicast session also uses 2 ports. Those 2
