...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <h3>Queue Size</h3>
    <p>
        The number of concurrent computers that can be imaged. The rest will sit in a queue until one is finished. Does not apply to multicast, on demand, and uploads. This is globally applied to
