...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <p>
        Sets the current criteria used for adding computers to a smart group. Currently there is only one option, where computer name contains.
        ...
        not get applied to the group until you click Update Criteria. This page is only visible for smart groups.
    </p>
</asp:Content>