...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <p>
        The CloneDeploy Core Client Scripts can also be edited here. When modifying the Core Client Scripts you are modifying the
        ...
        you start editing them. Only administrators have access to this page.
    </p>
</asp:Content>