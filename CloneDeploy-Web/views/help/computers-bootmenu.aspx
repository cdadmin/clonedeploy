...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <h3>Active</h3>
    <p>
        The active page displays the current boot menu file that will be displayed when this specific computer is PXE booted. It could be
    ...
    <h3>Custom</h3>
    <p>
        The custom page allows you to set a custom boot menu that only applies to this computer. It will stand in place of the global default
        ...
        select to use a template that can be created in Global->Boot Menu Templates
    </p>
