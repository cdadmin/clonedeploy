<%@ Page Title="" Language="C#" MasterPageFile="~/views/groups/groups.master" AutoEventWireup="true" Inherits="CloneDeploy_Web.views.groups.GroupBootMenu" Codebehind="bootmenu.aspx.cs" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Help">
    ...
    <li>
        <a href="<%= ResolveUrl("~/views/help/groups-bootmenu.aspx") %>" target="_blank">Help</a>
    </li>
</asp:Content>
