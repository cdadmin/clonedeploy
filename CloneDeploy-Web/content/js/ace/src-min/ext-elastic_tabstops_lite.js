define("ace/ext/elastic_tabstops_lite", ["require", "exports", "module", "ace/editor", "ace/config"], function(e, t, n) {
    ...
    var r = function(e) {
        this.$editor = e;
        var t = this, n = [], r = !1;
        this.onAfterExec = function() { r = !1, t.processRows(n), n = [] }, this.onExec = function() { r = !0 }, this.onChange = function(e) {
            var t = e.data.range;
    ...
    (function() {
        this.processRows = function(e) {
            ...
            var t = this.$selectionColumnsForRow(e), n = [-1].concat(this.$tabsForRow(e)), r = n.map(function(e) { return 0 }).slice(1), i = this.$editor.session.getLine(e);
