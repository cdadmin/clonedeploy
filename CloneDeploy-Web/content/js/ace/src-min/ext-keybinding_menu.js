define("ace/ext/menu_tools/overlay_page", ["require", "exports", "module", "ace/lib/dom"], function(e, t, n) {
    ...
    n.exports.getEditorKeybordShortcuts = function(e) {
        ...
        return e.keyBinding.$handlers.forEach(function(e) {
            ...
            for (var r in t) {
                var s = r.replace(/(^|-)\w/g, function(e) { return e.toUpperCase() }), o = t[r];
                Array.isArray(o) || (o = [o]), o.forEach(function(e) { typeof e != "string" && (e = e.name), i[e] ? i[e].key += "|" + s : (i[e] = { key: s, command: e }, n.push(i[e])) })
            }
        }), n
    }
