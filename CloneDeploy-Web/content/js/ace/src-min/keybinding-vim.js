define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function(e, t, n) {
    ...
    function r() {
        function t(e) { return typeof e != "object" ? e + "" : "line" in e ? e.line + ":" + e.ch : "anchor" in e ? t(e.anchor) + "->" + t(e.head) : Array.isArray(e) ? "[" + e.map(function(e) { return t(e) }) + "]" : JSON.stringify(e) }
    ...
    function m(e) { return{ row: e.line, column: e.ch } }

    function g(e) { return new w(e.row, e.column) }

    function S(e) { e.setOption("disableInput", !0), e.setOption("showCursorWhenSelecting", !1), v.signal(e, "vim-mode-change", { mode: "normal" }), e.on("cursorActivity", Xn), et(e), v.on(e.getInputField(), "paste", O(e)) }

    function x(e) { e.setOption("disableInput", !1), e.off("cursorActivity", Xn), v.off(e.getInputField(), "paste", O(e)), e.state.vim = null }

    function T(e, t) { this == v.keyMap.vim && v.rmClass(e.getWrapperElement(), "cm-fat-cursor"), (!t || t.attach != N) && x(e, !1) }

    function N(e, t) { this == v.keyMap.vim && v.addClass(e.getWrapperElement(), "cm-fat-cursor"), (!t || t.attach != N) && S(e) }
    ...
    function O(e) {
        var t = e.state.vim;
        return t.onPasteFn || (t.onPasteFn = function() { t.insertMode || (e.setCursor(wt(e.getCursor(), 0, 1)), mt.enterInsertMode(e, {}, t)) }), t.onPasteFn
    }
    ...
    function q(e, t) { return t >= e.firstLine() && t <= e.lastLine() }

    function R(e) { return/^[a-z]$/.test(e) }

    function U(e) { return"()[]{}".indexOf(e) != -1 }

    function z(e) { return M.test(e) }

    function W(e) { return/^[A-Z]$/.test(e) }

    function X(e) { return/^\s*$/.test(e) }
    ...
    function J(e, t, n, r, i) {
        ...
        n || (n = "string"), $[e] = { type: n, defaultValue: t, callback: i };
        if (r)for (var s = 0; s < r.length; s++)$[r[s]] = $[e];
        t && K(e, t)
    }
    ...
    function Z() { this.latestRegister = undefined, this.isPlaying = !1, this.isRecording = !1, this.replaySearchQueries = [], this.onRecordingDone = undefined, this.lastInsertModeChanges = Y() }

    function et(e) { return e.state.vim || (e.state.vim = { inputState: new st, lastEditInputState: undefined, lastEditActionCommand: undefined, lastHPos: -1, lastHSPos: -1, lastMotion: null, marks: {}, fakeCursor: null, insertMode: !1, insertModeRepeat: undefined, visualMode: !1, visualLine: !1, visualBlock: !1, lastSelection: null, lastPastedText: null, sel: {}, options: {} }), e.state.vim }

    function nt() {
        tt = { searchQuery: null, searchIsReversed: !1, lastSubstituteReplacePart: undefined, jumpList: G(), macroModeState: new Z, lastChararacterSearch: { increment: 0, forward: !0, selectedCharacter: "" }, registerController: new at({}), searchHistoryController: new ft({}), exCommandHistoryController: new ft({}) };
        for (var e in $) {
            var t = $[e];
    ...
    function st() { this.prefixRepeat = [], this.motionRepeat = [], this.operator = null, this.operatorArgs = null, this.motion = null, this.motionArgs = null, this.keyBuffer = [], this.registerName = null }

    function ot(e, t) { e.state.vim.inputState = new st, v.signal(e, "vim-command-done", t) }

    function ut(e, t, n) { this.clear(), this.keyBuffer = [e || ""], this.insertModeChanges = [], this.searchQueries = [], this.linewise = !!t, this.blockwise = !!n }

    function at(e) { this.registers = e, this.unnamedRegister = e['"'] = new ut, e["."] = new ut, e[":"] = new ut, e["/"] = new ut }

    function ft() { this.historyBuffer = [], this.iterator, this.initialPrefix = null }

    function ht(e, t) { ct[e] = t }
    ...
    function vt(e, t) { dt[e] = t }

    function gt(e, t) { mt[e] = t }
    ...
    function wt(e, t, n) { return typeof t == "object" && (n = t.ch, t = t.line), w(e.line + t, e.ch + n) }

    function Et(e, t) { return{ line: t.line - e.line, ch: t.line - e.line } }
    ...
    function Nt(e, t, n) { return function() { for (var r = 0; r < n; r++)t(e) } }

    function Ct(e) { return w(e.line, e.ch) }

    function kt(e, t) { return e.ch == t.ch && e.line == t.line }

    function Lt(e, t) { return e.line < t.line ? !0 : e.line == t.line && e.ch < t.ch ? !0 : !1 }

    function At(e, t) { return arguments.length > 2 && (t = At.apply(undefined, Array.prototype.slice.call(arguments, 1))), Lt(e, t) ? e : t }

    function Ot(e, t) { return arguments.length > 2 && (t = Ot.apply(undefined, Array.prototype.slice.call(arguments, 1))), Lt(e, t) ? t : e }
    ...
    function _t(e, t) { return e.getLine(t).length }

    function Dt(e) { return e.trim ? e.trim() : e.replace(/^\s+|\s+$/g, "") }

    function Pt(e) { return e.replace(/([.?*+$\[\]\/\\(){}|\-])/g, "\\$1") }
        ...
        var n = t.lastSelection,
            ...
            i = function() {
                ...
                if (i) {
                    ...
                    r = { line: r.line + d, ch: d ? r.ch : v + r.ch }, n.visualLine && (t = w(t.line, 0), r = w(r.line, _t(e, r.line))), e.setSelection(t, r)
                }
                return[t, r]
            };
    ...
    function qt(e, t) {
        ...
        t.lastPastedText && (r = e.posFromIndex(e.indexFromPos(n) + t.lastPastedText.length), t.lastPastedText = null), t.lastSelection = { anchorMark: e.setBookmark(n), headMark: e.setBookmark(r), anchor: Ct(n), head: Ct(r), visualMode: t.visualMode, visualLine: t.visualLine, visualBlock: t.visualBlock }
    }
    ...
    function $t(e, t, n) { t.ch = 0, n.ch = 0, n.line++ }
    ...
    function Qt(e, t, n) { kt(t, n) || tt.jumpList.add(e, t, n) }

    function Gt(e, t) { tt.lastChararacterSearch.increment = e, tt.lastChararacterSearch.forward = t.forward, tt.lastChararacterSearch.selectedCharacter = t.selectedCharacter }

    function en(e, t, n, r) {
        var i = Ct(e.getCursor()), s = n ? 1 : -1, o = n ? e.lineCount() : -1, u = i.ch, a = i.line, f = e.getLine(a), l = { lineText: f, nextCh: f.charAt(u), lastCh: null, index: u, symb: r, reverseSymb: (n ? { ")": "(", "}": "{" } : { "(": ")", "{": "}" })[r], forward: n, depth: 0, curMoveThrough: !1 }, c = Yt[r];
        if (!c)return i;
    ...
    function an(e, t, n, r, i) {
        function c(t) { return!/\S/.test(e.getLine(t)) }

        function h(e, t, n) { return n ? c(e) != c(e + t) : !c(e) && c(e + t) }
    ...
    function fn(e, t, n, r) {
        var i = t, s, o, u = { "(": /[()]/, ")": /[()]/, "[": /[[\]]/, "]": /[[\]]/, "{": /[{}]/, "}": /[{}]/ }[n], a = { "(": "(", ")": "(", "[": "[", "]": "[", "{": "{", "}": "{" }[n], f = e.getLine(i.line).charAt(i.ch), l = f === a ? 1 : 0;
    ...
    function pn(e, t, n, r, i) { e.openDialog ? e.openDialog(t, r, { bottom: !0, value: i.value, onKeyDown: i.onKeyDown, onKeyUp: i.onKeyUp, selectValueOnOpen: !1 }) : r(prompt(n, "")) }
    ...
    function wn(e, t) { e.openNotification ? e.openNotification('<span style="color: red">' + t + "</span>", { bottom: !0, duration: 5e3 }) : alert(t) }
    ...
    function On(e, t, n) { return typeof e != "number" && (e = e.line), t instanceof Array ? V(e, t) : n ? e >= t && e <= n : e == t }
    ...
    function Vn(e) {
        var t = e.state.vim, n = yt(e, Ct(t.sel.head)), r = wt(n, 0, 1);
    ...
    function $n(e, t) {
        ...
        t.visualMode && !e.somethingSelected() ? Xt(e, !1) : !t.visualMode && !t.insertMode && e.somethingSelected() && (t.visualMode = !0, t.visualLine = !1, v.signal(e, "vim-mode-change", { mode: "visual" }));
        if (t.visualMode) {
            var i = Lt(r, n) ? 0 : -1, s = Lt(r, n) ? -1 : 0;
            r = wt(r, 0, i), n = wt(n, 0, s), t.sel = { anchor: n, head: r }, on(e, t, "<", At(r, n)), on(e, t, ">", Ot(r, n))
        } else t.insertMode || (t.lastHPos = e.getCursor().ch)
    }

    function Jn(e) { this.keyName = e }

    function Kn(e) {
        function i() { return n.changes.push(new Jn(r)), !0 }
    ...
    function Qn(e, t, n, r) {
        function u() { s ? lt.processAction(e, t, t.lastEditActionCommand) : lt.evalInput(e, t) }
        ...
        if (s && t.lastEditActionCommand.interlaceInsertRepeat)for (var f = 0; f < n; f++)u(), a(1);
        else r || u(), a(n);
        t.inputState = o, t.insertMode && !r && jn(e), i.isPlaying = !1
    }

    function Gn(e, t, n) {
        function r(t) { return typeof t == "string" ? v.commands[t](e) : t(e), !0 }
        ...
        for (var f = 0; f < n; f++) {
            ...
            for (var l = 0; l < t.length; l++) {
                var c = t[l];
                if (c instanceof Jn)v.lookupKey(c.keyName, "vim-insert", r);
                else {
                    var h = e.getCursor();
    ...
    function nr(e, t, n) {
        ...
        if (t == "<Esc>" && !i.insertMode && !i.visualMode && e.ace.inMultiSelectMode)e.ace.exitMultiSelectMode();
        else if (s || !e.ace.inMultiSelectMode || e.ace.inVirtualSelectionMode)r = E.handleKey(e, t, n);
        else {
            var o = tr(i);
            e.operation(function() {
    ...
    e("../multi_select");
    var v = function(e) { this.ace = e, this.state = {}, this.marks = {}, this.$uid = 0, this.onChange = this.onChange.bind(this), this.onSelectionChange = this.onSelectionChange.bind(this), this.onBeforeEndOperation = this.onBeforeEndOperation.bind(this), this.ace.on("change", this.onChange), this.ace.on("changeSelection", this.onSelectionChange), this.ace.on("beforeEndOperation", this.onBeforeEndOperation) };
    v.Pos = function(e, t) {
        if (!(this instanceof w))return new w(e, t);
        this.line = e, this.ch = t
    }, v.defineOption = function(e, t, n) {}, v.commands = { redo: function(e) { e.ace.redo() }, undo: function(e) { e.ace.undo() }, newlineAndIndent: function(e) { e.ace.insert("\n") } }, v.keyMap = {}, v.addClass = v.rmClass = v.e_stop = function() {}, v.keyName = function(e) {
        if (e.key)return e.key;
        var t = a[e.keyCode] || "";
        return t.length == 1 && (t = t.toUpperCase()), t = f.getModifierString(e).replace(/(^|-)\w/g, function(e) { return e.toUpperCase() }) + t, t
    ...
    }, v.signal = function(e, t, n) { return e._signal(t, n) }, v.on = f.addListener, v.off = f.removeListener, v.isWordChar = function(e) { return d.lastIndex = 0, d.test(e) }, function() {
        u.implement(v.prototype, s), this.destroy = function() { this.ace.off("change", this.onChange), this.ace.off("changeSelection", this.onSelectionChange), this.ace.off("beforeEndOperation", this.onBeforeEndOperation), this.removeOverlay() }, this.virtualSelectionMode = function() { return this.ace.inVirtualSelectionMode && this.ace.selection.index }, this.onChange = function(e) {
            var t = e.data;
            ...
            return!t.length || this.ace.inVirtualSelectionMode ? [{ anchor: this.getCursor("anchor"), head: this.getCursor("head") }] : t.map(function(e) { return{ anchor: this.clipPos(g(e.cursor == e.end ? e.start : e.end)), head: this.clipPos(g(e.cursor)) } }, this)
        ...
        }, this.somethingSelected = function(e) { return!this.ace.selection.isEmpty() }, this.clipPos = function(e) {
            var t = this.ace.session.$clipPositionToDocument(e.line, e.ch);
            return g(t)
        }, this.markText = function(e) { return{ clear: function() {}, find: function() {} } }, this.$updateMarkers = function(e) {
        ...
        var e = function(e, t, n, r) { this.cm = e, this.id = t, this.row = n, this.column = r, e.marks[this.id] = this };
        e.prototype.clear = function() { delete this.cm.marks[this.id] }, e.prototype.find = function() { return g(this) }, this.setBookmark = function(t, n) {
            ...
            return{
                findNext: function() { return this.find(!1) }, findPrevious: function() { return this.find(!0) },
                find: function(t) {
                ...
                from: function() { return a && g(a.start) },
                to: function() { return a && g(a.end) },
                replace: function(e) { a && (a.end = u.ace.session.doc.replace(a, e)) }
            }
        ...
        }, this.scrollInfo = function() { return 0 }, this.scrollIntoView = function(e, t) {
            if (e) {
                var n = this.ace.renderer, r = { top: 0, bottom: t };
                n.scrollCursorIntoView(m(e), n.lineHeight * 2 / n.$size.scrollerHeight, r)
            }
        }, this.getLine = function(e) { return this.ace.session.getLine(e) }, this.getRange = function(e, t) { return this.ace.session.getTextRange(new i(e.line, e.ch, t.line, t.ch)) }, this.replaceRange = function(e, t, n) { return n || (n = t), this.ace.session.replace(new i(t.line, t.ch, n.line, n.ch), e) }, this.replaceSelections = function(e) {
        ...
        }, this.getSelection = function() { return this.ace.getSelectedText() }, this.getSelections = function() { return this.listSelections().map(function(e) { return this.getRange(e.anchor, e.head) }, this) }, this.getInputField = function() { return this.ace.textInput.getElement() }, this.getWrapperElement = function() { return this.ace.containter };
        ...
        this.setOption = function(e, n) {
        ...
        }, this.toggleOverwrite = function(e) { return this.state.overwrite = e, this.ace.setOverwrite(e) }, this.addOverlay = function(e) {
            if (!this.$searchHighlight || !this.$searchHighlight.session) {
                var t = new h(null, "ace_highlight-marker", "text"), n = this.ace.session.addDynamicMarker(t);
                t.id = n.id, t.session = this.ace.session, t.destroy = function(e) { t.session.off("change", t.updateOnChange), t.session.off("changeEditor", t.destroy), t.session.removeMarker(t.id), t.session = null }, t.updateOnChange = function(e) {
                    e = e.data.range;
                    var n = e.start.row;
        ...
        }, this.removeOverlay = function(e) { this.$searchHighlight && this.$searchHighlight.session && this.$searchHighlight.destroy() }, this.getScrollInfo = function() {
            var e = this.ace.renderer, t = e.layerConfig;
            return{ left: e.scrollLeft, top: e.scrollTop, height: t.maxHeight, width: t.width, clientHeight: t.height, clientWidth: t.width }
        }, this.getValue = function() { return this.ace.getValue() }, this.setValue = function(e) { return this.ace.setValue(e) }, this.getTokenTypeAt = function(e) {
            ...
            return{ to: t && g(t) }
        }, this.indentLine = function(e, t) { t === !0 ? this.ace.session.indentRows(e, e, "	") : t === !1 && this.ace.session.outdentRows(new i(e, 0, e, 0)) }, this.indexFromPos = function(e) { return this.ace.session.doc.positionToIndex(m(e)) }, this.posFromIndex = function(e) { return g(this.ace.session.doc.indexToPosition(e)) }, this.focus = function(e) { return this.ace.focus() }, this.blur = function(e) { return this.ace.blur() }, this.defaultTextHeight = function(e) { return this.ace.renderer.layerConfig.lineHeight }, this.scanForBracket = function(e, t, n, r) {
            var i = r.bracketRegex.source;
            if (t == 1)var s = this.ace.session.$findClosingBracket(i.slice(1, 2), m(e), /paren|text/);
            else var s = this.ace.session.$findOpeningBracket(i.slice(-2, -1), { row: e.line, column: e.ch + 1 }, /paren|text/);
            return s && { pos: g(s) }
        }, this.refresh = function() { return this.ace.resize(!0) }, this.getMode = function() { return{ name: this.getOption("mode") } }
    }.call(v.prototype);
    var y = v.StringStream = function(e, t) { this.pos = this.start = 0, this.string = e, this.tabSize = t || 8, this.lastColumnPos = this.lastColumnValue = 0, this.lineStart = 0 };
    y.prototype = {
        eol: function() { return this.pos >= this.string.length }, sol: function() { return this.pos == this.lineStart }, peek: function() { return this.string.charAt(this.pos) || undefined }, next: function() { if (this.pos < this.string.length)return this.string.charAt(this.pos++) },
        eat: function(e) {
        ...
        backUp: function(e) { this.pos -= e },
        column: function() { throw"not implemented" },
        indentation: function() { throw"not implemented" },
        match: function(e, t, n) {
            if (typeof e != "string") {
                var s = this.string.slice(this.pos).match(e);
                return s && s.index > 0 ? null : (s && t !== !1 && (this.pos += s[0].length), s)
            }
            var r = function(e) { return n ? e.toLowerCase() : e }, i = this.string.substr(this.pos, e.length);
    ...
    var G = function() {
        ...
        Y = function(e) { return e ? { changes: e.changes, expectCursorActivityForChange: e.expectCursorActivityForChange } : { changes: [], expectCursorActivityForChange: !1 } };
    Z.prototype = {
    ...
    var tt, rt,
        it = {
            ...
            findKey: function(e, t, n) {
                ...
                function s() { if (t == "<Esc>")return ot(e), r.visualMode ? Xt(e) : r.insertMode && jn(e), !0 }
                ...
                function u() {
                    ...
                    if (o.type == "partial")return rt && window.clearTimeout(rt), rt = window.setTimeout(function() { r.insertMode && r.inputState.keyBuffer && ot(e) }, Q("insertModeEscKeysTimeout")), !i;
                ...
                var r = et(e), f;
                return r.insertMode ? f = u() : f = a(), f === !1 ? undefined : f === !0 ? function() {} : function() {
            ...
            handleEx: function(e, t) { Hn.processCommand(e, t) },
            defineMotion: ht,
            defineAction: gt,
            defineOperator: vt,
            mapCommand: In,
    ...
    st.prototype.pushRepeatDigit = function(e) { this.operator ? this.motionRepeat = this.motionRepeat.concat(e) : this.prefixRepeat = this.prefixRepeat.concat(e) }, st.prototype.getRepeat = function() {
        var e = 0;
        ...
        return e
    }, ut.prototype = { setText: function(e, t, n) { this.keyBuffer = [e || ""], this.linewise = !!t, this.blockwise = !!n }, pushText: function(e, t) { t && (this.linewise || this.keyBuffer.push("\n"), this.linewise = !0), this.keyBuffer.push(e) }, pushInsertModeChanges: function(e) { this.insertModeChanges.push(Y(e)) }, pushSearchQuery: function(e) { this.searchQueries.push(e) }, clear: function() { this.keyBuffer = [], this.insertModeChanges = [], this.searchQueries = [], this.linewise = !1 }, toString: function() { return this.keyBuffer.join("") } }, at.prototype = {
        ...
        getRegister: function(e) { return this.isValidRegister(e) ? (e = e.toLowerCase(), this.registers[e] || (this.registers[e] = new ut), this.registers[e]) : this.unnamedRegister },
        isValidRegister: function(e) { return e && V(e, I) },
        shiftNumericRegisters_: function() { for (var e = 9; e >= 2; e--)this.registers[e] = this.getRegister("" + (e - 1)) }
    }, ft.prototype = {
        ...
        reset: function() { this.initialPrefix = null, this.iterator = this.historyBuffer.length }
    };
    var lt = {
            ...
            processMotion: function(e, t, n) { t.inputState.motion = n.motion, t.inputState.motionArgs = bt(n.motionArgs), this.evalInput(e, t) },
            ...
            processSearch: function(e, t, n) {
                function a(r, i, s) {
                    ...
                    lt.processMotion(e, t, { type: "motion", motion: "findNext", motionArgs: { forward: !0, toJumplist: n.searchArgs.toJumplist } })
                }
                ...
                function c(t, n, r) {
                    var i = v.keyName(t);
                    i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" || i == "Backspace" && n == "" ? (tt.searchHistoryController.pushInput(n), tt.searchHistoryController.reset(), Nn(e, o), An(e), e.scrollTo(u.left, u.top), v.e_stop(t), ot(e), r(), e.focus()) : i == "Ctrl-U" && (v.e_stop(t), r(""))
                }
            ...
            processEx: function(e, t, n) {
                function r(t) { tt.exCommandHistoryController.pushInput(t), tt.exCommandHistoryController.reset(), Hn.processCommand(e, t) }

                function i(t, n, r) {
                    var i = v.keyName(t), s;
                    if (i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" || i == "Backspace" && n == "")tt.exCommandHistoryController.pushInput(n), tt.exCommandHistoryController.reset(), v.e_stop(t), ot(e), r(), e.focus();
                    i == "Up" || i == "Down" ? (s = i == "Up" ? !0 : !1, n = tt.exCommandHistoryController.nextMatch(n, s) || "", r(n)) : i == "Ctrl-U" ? (v.e_stop(t), r("")) : i != "Left" && i != "Right" && i != "Ctrl" && i != "Alt" && i != "Shift" && tt.exCommandHistoryController.reset()
                }

                n.type == "keyToEx" ? Hn.processCommand(e, n.exArgs.input) : t.visualMode ? xn(e, { onClose: r, prefix: ":", value: "'<,'>", onKeyDown: i, select: !1 }) : xn(e, { onClose: r, prefix: ":", onKeyDown: i })
            },
            evalInput: function(e, t) {
                var n = t.inputState, r = n.motion, i = n.motionArgs || {}, s = n.operator, o = n.operatorArgs || {}, u = n.registerName, a = t.sel, f = Ct(t.visualMode ? yt(e, a.head) : e.getCursor("head")), l = Ct(t.visualMode ? yt(e, a.anchor) : e.getCursor("anchor")), c = Ct(f), h = Ct(l), p, d, v;
                ...
                else if (i.noRepeat || !i.explicitRepeat && v === 0)v = 1, i.repeatIsExplicit = !1;
                ...
                if (r) {
                    ...
                    if (!m)return;
                    if (i.toJumplist) {
                        s || (e.ace.curOp.command.scrollIntoView = "center-animate");
                ...
                if (s) {
                    if (o.lastSel) {
                        ...
                        b.visualLine ? p = w(h.line + E, h.ch) : b.visualBlock ? p = w(h.line + E, h.ch + S) : b.head.line == b.anchor.line ? p = w(h.line, h.ch + S) : p = w(h.line + E, h.ch), t.visualMode = !0, t.visualLine = b.visualLine, t.visualBlock = b.visualBlock, a = t.sel = { anchor: d, head: p }, Ut(e)
                    } else t.visualMode && (o.lastSel = { anchor: Ct(a.anchor), head: Ct(a.head), visualBlock: t.visualBlock, visualLine: t.visualLine });
                    var x, T, N, C, k;
                    if (t.visualMode) {
                        x = At(a.head, a.anchor), T = Ot(a.head, a.anchor), N = t.visualLine || o.linewise, C = t.visualBlock ? "block" : N ? "line" : "char", k = zt(e, { anchor: x, head: T }, C);
                        if (N) {
                            var L = k.ranges;
                            if (C == "block")for (var A = 0; A < L.length; A++)L[A].head.ch = _t(e, L[A].head.line);
                            else C == "line" && (L[0].head = w(L[0].head.line + 1, 0))
                        }
                    } else {
                        x = Ct(d || h), T = Ct(p || c);
                        if (Lt(T, x)) {
        ...
        ct = {
            ...
            moveByDisplayLines: function(e, t, n, r) {
                ...
                if (o.hitSide)
                    if (n.forward)var u = e.charCoords(o, "div"), a = { top: u.top + 8, left: r.lastHSPos }, o = e.coordsChar(a, "div");
                    else {
            ...
            moveByWords: function(e, t, n) { return nn(e, t, n.repeat, !!n.forward, !!n.wordEnd, !!n.bigWord) },
            ...
            moveToStartOfLine: function(e, t) { return w(t.line, 0) },
            ...
            textObjectManipulation: function(e, t, n, r) {
                var i = { "(": ")", ")": "(", "{": "}", "}": "{", "[": "]", "]": "[" }, s = { "'": !0, '"': !0 }, o = n.selectedCharacter;
                o == "b" ? o = "(" : o == "B" && (o = "{");
                var u = !n.textObjectInner, a;
                if (i[o])a = fn(e, t, o, u);
                else if (s[o])a = ln(e, t, o, u);
                else if (o === "W")a = Kt(e, u, !0, !0);
                else if (o === "w")a = Kt(e, u, !0, !1);
                else {
                    if (o !== "p")return null;
        ...
        dt = {
            change: function(e, t, n) {
                ...
                if (!s.visualMode) {
                    ...
                    if (a.motion == "moveByWords" && !X(i)) {
                        var f = /\s+$/.exec(i);
                        f && a.motionArgs && a.motionArgs.forward && (u = wt(u, 0, -f[0].length), i = i.slice(0, -f[0].length))
                    }
                    var l = u.line - 1 == e.lastLine();
                    e.replaceRange("", o, u), t.linewise && !l && (v.commands.newlineAndIndent(e), o.ch = null), r = o
                } else {
                    i = e.getSelection();
                    var c = pt("", n.length);
                    e.replaceSelections(c), r = At(n[0].head, n[0].anchor)
                }
        ...
        mt = {
            ...
            scroll: function(e, t, n) {
                ...
                if (t.forward)u > f.top ? (a.line += (u - f.top) / i, a.line = Math.ceil(a.line), e.setCursor(a), f = e.charCoords(a, "local"), e.scrollTo(null, f.top)) : e.scrollTo(null, u);
                else {
            ...
            enterInsertMode: function(e, t, n) {
                ...
                if (r == "eol")s = w(s.line, _t(e, s.line));
                else if (r == "charAfter")s = wt(s, 0, 1);
                else if (r == "firstNonBlank")s = ct.moveToFirstNonWhiteSpaceCharacter(e, s);
                else if (r == "startOfSelectedArea")n.visualBlock ? (s = w(Math.min(i.head.line, i.anchor.line), Math.min(i.head.ch, i.anchor.ch)), o = Math.abs(i.head.line - i.anchor.line) + 1) : i.head.line < i.anchor.line ? s = i.head : s = w(i.anchor.line, 0);
                else if (r == "endOfSelectedArea")n.visualBlock ? (s = w(Math.min(i.head.line, i.anchor.line), Math.max(i.head.ch + 1, i.anchor.ch)), o = Math.abs(i.head.line - i.anchor.line) + 1) : i.head.line >= i.anchor.line ? s = wt(i.head, 0, 1) : s = w(i.anchor.line, 0);
            ...
            toggleVisualMode: function(e, t, n) {
                ...
                n.visualMode ? n.visualLine ^ t.linewise || n.visualBlock ^ t.blockwise ? (n.visualLine = !!t.linewise, n.visualBlock = !!t.blockwise, v.signal(e, "vim-mode-change", { mode: "visual", subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : "" }), Ut(e)) : Xt(e) : (n.visualMode = !0, n.visualLine = !!t.linewise, n.visualBlock = !!t.blockwise, s = yt(e, w(i.line, i.ch + r - 1), !0), n.sel = { anchor: i, head: s }, v.signal(e, "vim-mode-change", { mode: "visual", subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : "" }), Ut(e), on(e, n, "<", At(i, s)), on(e, n, ">", Ot(i, s)))
            },
            reselectLastSelection: function(e, t, n) {
                ...
                if (r) {
                    ...
                    if (!i || !s)return;
                    n.sel = { anchor: i, head: s }, n.visualMode = !0, n.visualLine = r.visualLine, n.visualBlock = r.visualBlock, Ut(e), on(e, n, "<", At(i, s)), on(e, n, ">", Ot(i, s)), v.signal(e, "vim-mode-change", { mode: "visual", subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : "" })
                }
            },
            ...
            undo: function(e, t) { e.operation(function() { Nt(e, v.commands.undo, t.repeat)(), e.setCursor(e.getCursor("anchor")) }) },
            redo: function(e, t) { Nt(e, v.commands.redo, t.repeat)() },
            setRegister: function(e, t, n) { n.inputState.registerName = t.selectedCharacter },
            ...
            replace: function(e, t, n) {
                ...
                if (r == "\n")n.visualMode || e.replaceRange("", i, o), (v.commands.newlineAndIndentContinueComment || v.commands.newlineAndIndent)(e);
                else {
        ...
        Yt = { "(": "bracket", ")": "bracket", "{": "bracket", "}": "bracket", "[": "section", "]": "section", "*": "comment", "/": "comment", m: "method", M: "method", "#": "preprocess" },
        Zt = {
            bracket: {
            ...
            section: { init: function(e) { e.curMoveThrough = !0, e.symb = (e.forward ? "]" : "[") === e.symb ? "{" : "}" }, isComplete: function(e) { return e.index === 0 && e.nextCh === e.symb } },
            comment: {
                isComplete: function(e) {
            ...
            method: { init: function(e) { e.symb = e.symb === "m" ? "{" : "}", e.reverseSymb = e.symb === "{" ? "}" : "{" }, isComplete: function(e) { return e.nextCh === e.symb ? !0 : !1 } },
            preprocess: {
                init: function(e) { e.index = 0 },
                isComplete: function(e) {
                    if (e.nextCh === "#") {
    ...
    J("pcre", !0, "boolean"), cn.prototype = { getQuery: function() { return tt.query }, setQuery: function(e) { tt.query = e }, getOverlay: function() { return this.searchOverlay }, setOverlay: function(e) { this.searchOverlay = e }, isReversed: function() { return tt.isReversed }, setReversed: function(e) { tt.isReversed = e }, getScrollbarAnnotate: function() { return this.annotate }, setScrollbarAnnotate: function(e) { this.annotate = e } };
    var Sn = "(Javascript regexp)", _n = [{ name: "colorscheme", shortName: "colo" }, { name: "map" }, { name: "imap", shortName: "im" }, { name: "nmap", shortName: "nm" }, { name: "vmap", shortName: "vm" }, { name: "unmap" }, { name: "write", shortName: "w" }, { name: "undo", shortName: "u" }, { name: "redo", shortName: "red" }, { name: "set", shortName: "se" }, { name: "set", shortName: "se" }, { name: "setlocal", shortName: "setl" }, { name: "setglobal", shortName: "setg" }, { name: "sort", shortName: "sor" }, { name: "substitute", shortName: "s", possiblyAsync: !0 }, { name: "nohlsearch", shortName: "noh" }, { name: "delmarks", shortName: "delm" }, { name: "registers", shortName: "reg", excludeFromCommandHistory: !0 }, { name: "global", shortName: "g" }], Dn = function() { this.buildCommandMap_() };
    Dn.prototype = {
        processCommand: function(e, t, n) {
            var r = this;
            e.operation(function() { e.curOp.isVimOp = !0, r._processCommand(e, t, n) })
        },
        ...
        map: function(e, t, n) {
            if (e != ":" && e.charAt(0) == ":") {
                ...
                var r = e.substring(1);
                t != ":" && t.charAt(0) == ":" ? this.commandMap_[r] = { name: r, type: "exToEx", toInput: t.substring(1), user: !0 } : this.commandMap_[r] = { name: r, type: "exToKey", toKeys: t, user: !0 }
    ...
    var Pn = {
            ...
            imap: function(e, t) { this.map(e, t, "insert") },
            nmap: function(e, t) { this.map(e, t, "normal") },
            vmap: function(e, t) { this.map(e, t, "visual") },
            ...
            move: function(e, t) { lt.processCommand(e, e.state.vim, { type: "motion", motion: "moveToLineOrEdgeOfDocument", motionArgs: { forward: !1, explicitRepeat: !0, linewise: !0 }, repeatOverride: t.line + 1 }) },
            set: function(e, t) {
                ...
                var a = $[s] && $[s].type == "boolean";
                a && o == undefined && (o = !0);
                if (!a && o === undefined || u) {
                    var f = Q(s, e, r);
                    f === !0 || f === !1 ? wn(e, " " + (f ? "" : "no") + s) : wn(e, "  " + s + "=" + f)
                } else K(s, o, e, r)
            },
            setlocal: function(e, t) { t.setCfg = { scope: "local" }, this.set(e, t) },
            setglobal: function(e, t) { t.setCfg = { scope: "global" }, this.set(e, t) },
            ...
            sort: function(e, t) {
                ...
                if (s)for (var y = 0; y < h.length; y++)p.exec(h[y]) ? m.push(h[y]) : g.push(h[y]);
                else g = h;
            ...
            substitute: function(e, t) {
                ...
                if (r.length)i = r[0], s = r[1], s !== undefined && (Q("pcre") ? s = yn(s) : s = gn(s), tt.lastSubstituteReplacePart = s), o = r[2] ? r[2].split(" ") : [];
                else if (n && n.length) {
            ...
            write: function(e) { v.commands.save ? v.commands.save(e) : e.save() },
            nohlsearch: function(e) { An(e) },
        ...
        Hn = new Dn;
    v.keyMap.vim = { attach: N, detach: T, call: C }, J("insertModeEscKeysTimeout", 200, "number"), v.keyMap["vim-insert"] = {
        "Ctrl-N": "autocomplete", "Ctrl-P": "autocomplete",
        Enter: function(e) {
        ...
        detach: T,
        call: C
    }, v.keyMap["vim-replace"] = { Backspace: "goCharLeft", fallthrough: ["vim-insert"], attach: N, detach: T, call: C }, nt(), v.Vim = E(), E = v.Vim;
    var Yn = { "return": "CR", backspace: "BS", "delete": "Del", esc: "Esc", left: "Left", right: "Right", up: "Up", down: "Down", space: "Space", home: "Home", end: "End", pageup: "PageUp", pagedown: "PageDown", enter: "CR" }, er = E.handleKey.bind(E);
    E.handleKey = function(e, t, n) { return e.operation(function() { return er(e, t, n) }, !0) }, t.CodeMirror = v;
    ...
    t.handler = {
        ...
        handleKeyboard: function(e, t, n, r, i) {
            ...
            if (r == -1)return;
            if (n == "c" && t == 1) {
                if (!c.isMac && s.getCopyText())return s.once("copy", function() { s.selection.clearSelection() }), { command: "null", passEvent: !0 }
        ...
        attach: function(e) {
            ...
            }), t.on("changeStatus", function() { t.ace.renderer.updateCursor(), t.ace._signal("changeStatus") }), t.on("vim-mode-change", function() {
                if (t.virtualSelectionMode())return;
