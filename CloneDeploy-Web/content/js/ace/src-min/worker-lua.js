...
(function(e) {
    ...
    (function(e, n, r) { r(t) })(this, "luaparse", function(e) {
        "use strict";
        ...
        function E(e) {
            ...
            return e = e.replace(/%(\d)/g, function(e, n) { return"" + t[n - 1] || "" }), e
        }
        ...
        function T(e, t) { x(t, d.expectedToken, e, t.value) }
        ...
        function B() {
            ...
            return e = t.slice(M, C), nt(e) ? n = u : "true" === e || "false" === e ? (n = c, e = "true" === e) : "nil" === e ? (n = h, e = null) : n = a, { type: n, value: e, line: _, lineStart: D, range: [M, C] }
        }

        function j(e) { return C += e.length, { type: l, value: e, line: _, lineStart: D, range: [M, C] } }

        function F() { return C += 3, { type: p, value: "...", line: _, lineStart: D, range: [M, C] } }
        ...
        function I() {
            ...
            while (C < r) {
                ...
                else if (C >= r || G(s))i += t.slice(n, C - 1), x({}, d.unfinishedString, i + String.fromCharCode(s))
            }
        ...
        function q() {
            var e = V();
            return!1 === e && x(k, d.expected, "[", k.value), { type: o, value: e, line: _, lineStart: D, range: [M, C] }
        }
        ...
        function W() {
            ...
            case"z":
                return C++, H(), "";
            case"x":
                if (Z(t.charCodeAt(C + 1)) && Z(t.charCodeAt(C + 2)))return C += 3, "\\" + t.slice(e, C);
                return"\\" + t.charAt(C++);
            default:
                if (Y(t.charCodeAt(C))) {
        ...
        function X() {
            ...
            if (n.comments) {
                ...
                n.locations && (f.loc = { start: { line: a, column: M - u }, end: { line: _, column: C - D } }), n.ranges && (f.range = [M, C]), O.push(f)
            }
        }
        ...
        function $() { L = k, k = A, A = P() }

        function J(e) { return e === k.value ? ($(), !0) : !1 }

        function K(e) { e === k.value ? $() : x(k, d.expected, e, k.value) }

        function Q(e) { return 9 === e || 32 === e || 11 === e || 12 === e }

        function G(e) { return 10 === e || 13 === e }

        function Y(e) { return e >= 48 && e <= 57 }

        function Z(e) { return e >= 48 && e <= 57 || e >= 97 && e <= 102 || e >= 65 && e <= 70 }

        function et(e) { return e >= 65 && e <= 90 || e >= 97 && e <= 122 || 95 === e }

        function tt(e) { return e >= 65 && e <= 90 || e >= 97 && e <= 122 || 95 === e || e >= 48 && e <= 57 }
        ...
        function rt(e) { return l === e.type ? "#-".indexOf(e.value) >= 0 : u === e.type ? "not" === e.value : !1 }
        ...
        function ht(e) { ct(e.name), pt(e, !0) }

        function pt(e, t) { !t && -1 === w(at, "name", e.name) && at.push(e), e.isLocal = t }

        function dt(e) { return-1 !== b(ot[ut], e) }

        function gt() { return new yt(k) }

        function yt(e) { n.locations && (this.loc = { start: { line: e.line, column: e.range[0] - e.lineStart }, end: { line: 0, column: 0 } }), n.ranges && (this.range = [e.range[0], 0]) }

        function bt() { mt && vt.push(gt()) }

        function wt(e) { mt && vt.push(e) }
        ...
        function Nt() { return m(v.breakStatement()) }
        ...
        function jt() {
            ...
            while (J("."))wt(r), t = Ht(), n.scope && pt(t, !1), e = m(v.memberExpression(e, ".", t));
        ...
        function Ft() {
            ...
            for (;;) {
                bt();
                if (l === k.type && J("["))t = qt(), K("]"), K("="), n = qt(), e.push(m(v.tableKey(t, n)));
                else if (a === k.type)t = qt(), J("=") ? (n = qt(), e.push(m(v.tableKeyString(t, n)))) : e.push(m(v.tableValue(t)));
                else {
                    if (null == (n = It())) {
                        vt.pop();
                        break
        ...
        var d = e.errors = { unexpected: "Unexpected %1 '%2' near '%3'", expected: "'%1' expected near '%2'", expectedToken: "%1 expected near '%2'", unfinishedString: "unfinished string near '%1'", malformedNumber: "malformed number near '%1'" },
            v = e.ast = {
                ...
                unaryExpression: function(e, t) { return{ type: "UnaryExpression", operator: e, argument: t } },
                memberExpression: function(e, t, n) { return{ type: "MemberExpression", indexer: t, identifier: n, base: e } },
                indexExpression: function(e, t) { return{ type: "IndexExpression", base: e, index: t } },
                callExpression: function(e, t) { return{ type: "CallExpression", base: e, arguments: t } },
                tableCallExpression: function(e, t) { return{ type: "TableCallExpression", base: e, arguments: t } },
                stringCallExpression: function(e, t) { return{ type: "StringCallExpression", base: e, argument: t } },
                comment: function(e, t) { return{ type: "Comment", value: e, raw: t } }
            },
        ...
        e.lex = P;
        var ot, ut, at, vt = [], mt;
        yt.prototype.complete = function() { n.locations && (this.loc.end.line = L.line, this.loc.end.column = L.range[1] - L.lineStart), n.ranges && (this.range[1] = L.range[1]) }, e.parse = Vt, e.write = $t, e.end = Jt
    })
}), define("ace/mode/lua_worker", ["require", "exports", "module", "ace/lib/oop", "ace/worker/mirror", "ace/mode/lua/luaparse"], function(e, t, n) {
    "use strict";
    ...
    r.inherits(o, i), function() {
        this.onUpdate = function() {
            ...
            try {
                ...
                n instanceof SyntaxError && t.push({ row: n.line - 1, column: n.column, text: n.message, type: "error" })
            }
