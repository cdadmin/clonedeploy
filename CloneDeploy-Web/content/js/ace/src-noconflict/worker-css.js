                ...
                additions = {
                    ...
                    _margin_sym: function() {
                        ...
                        if (tokenStream.match([
                            Tokens.TOPLEFTCORNER_SYM, Tokens.TOPLEFT_SYM,
                    ...
                    _attrib: function() {
                        ...
                        if (tokenStream.match(Tokens.LBRACKET)) {
                            ...
                            if (tokenStream.match([
                                Tokens.PREFIXMATCH, Tokens.SUFFIXMATCH, Tokens.SUBSTRINGMATCH,
                    ...
                    _expression: function() {
                        ...
                        while (tokenStream.match([
                            Tokens.PLUS, Tokens.MINUS, Tokens.DIMENSION,
                    ...
                    _term: function(inFunction) {
                        ...
                        if (tokenStream.peek() == Tokens.IE_FUNCTION && this.options.ieFilters) {
                            ...
                            Tokens.NUMBER, Tokens.PERCENTAGE, Tokens.LENGTH,
