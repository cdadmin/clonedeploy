<%@ Page Title="" Language="C#" MasterPageFile="~/views/users/user.master" AutoEventWireup="true" CodeFile="addmembers.aspx.cs" Inherits="views_users_addmembers" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Help">
    <li role="separator" class="divider"></li>
     <li><a href="<%= ResolveUrl("~/views/help/users-groupaddmembers.aspx")%>" target="_blank">Help</a></li>
</asp:Content>
