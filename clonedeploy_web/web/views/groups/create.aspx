<%@ Page Title="" Language="C#" MasterPageFile="~/views/masters/Group.master" AutoEventWireup="true" Inherits="views.groups.GroupCreate" CodeFile="create.aspx.cs" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="SubContent" runat="Server">
    ...
    <div id="standardGroup" runat="server" visible="false">
        <div class="size-7 column">
            <asp:TextBox ID="txtSearchHosts" runat="server" AutoPostBack="True" CssClass="searchbox label-host-search" OnTextChanged="txtSearchHosts_TextChanged"></asp:TextBox>
        </div>
        <br class="clear"/>
        <p class="total">
            <asp:Label ID="lblTotal" runat="server"></asp:Label>
        </p>
        <asp:GridView ID="gvHosts" runat="server" AutoGenerateColumns="False" CssClass="Gridview" AlternatingRowStyle-CssClass="alt" DataKeyNames="Id">
            <Columns>
                <asp:TemplateField>
