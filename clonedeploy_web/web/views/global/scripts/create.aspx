<%@ Page Title="" Language="C#" MasterPageFile="~/views/global/scripts/scripts.master" AutoEventWireup="true" CodeFile="create.aspx.cs" Inherits="views_admin_scripts_create" ValidateRequest="False" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ActionsRightSub" Runat="Server">
     <asp:LinkButton ID="btnSubmit" runat="server" OnClick="btnSubmit_OnClick" Text="Add Script"  OnClientClick="update_click()" CssClass="btn btn-default"/>
