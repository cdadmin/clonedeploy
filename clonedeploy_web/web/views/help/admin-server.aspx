...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
    ...
    <p>The IP Address of your CloneDeploy server or the fully qualified domain name if using SSL.  This value is used in various locations in CloneDeploy and must be correct for client to server 
        communication.
    </p>
    ...
    <h3>Computer View</h3>
    <p>By default, anytime you search for computers in the WebUI, the initial view will display all computers before you change the search criteria.  If you have too many computers, this can take a long
