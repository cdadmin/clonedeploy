...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
   ...
   <p>A Proxy DHCP Reservation allows you to set specific computer to pxe boot in a specific way without effecting any other computers.
       ...
       model that may be incompatible with Linux.</p>
       <p>* The WinPE Boot File options do not display until the WinPE Imaging Environment has been enabled.</p>
       <p>* The TFTP server should most likely always be set to <b>[server-ip]</b></p>
