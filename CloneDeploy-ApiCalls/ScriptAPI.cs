...
namespace CloneDeploy_ApiCalls
{
    public class ScriptAPI : BaseAPI
    {
        ...
        public List<ScriptEntity> GetAll(int limit, string searchstring)
        {
            ...
            return new ApiRequest().Execute<List<ScriptEntity>>(_request);
        }
        ...
        public ScriptEntity Get(int id)
        {
            ...
            return new ApiRequest().Execute<ScriptEntity>(_request);
        }
