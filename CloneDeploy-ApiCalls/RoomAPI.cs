...
namespace CloneDeploy_ApiCalls
{
    public class RoomAPI : BaseAPI
    {
        ...
        public List<RoomEntity> GetAll(int limit, string searchstring)
        {
            ...
            return new ApiRequest().Execute<List<RoomEntity>>(_request);
        }
        ...
        public RoomEntity Get(int id)
        {
            ...
            return new ApiRequest().Execute<RoomEntity>(_request);
        }
