...
{
    public class ImageClassificationAPI : BaseAPI
    {
        private readonly ApiRequest _apiRequest;

        public ImageClassificationAPI(string resource) : base(resource)
        {
        ...
        public ImageClassificationEntity Get(int id)
        {
            ...
            return _apiRequest.Execute<ImageClassificationEntity>(Request);
        }

        public List<ImageClassificationEntity> Get()
        {
            Request.Method = Method.GET;
        ...
        public ActionResultDTO Post(ImageClassificationEntity tObject)
        {
        ...
        public ActionResultDTO Put(int id, ImageClassificationEntity tObject)
        {
