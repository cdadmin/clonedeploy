...
namespace CloneDeploy_ApiCalls
{
    public class FileFolderAPI : BaseAPI
    {
        ...
        public List<FileFolderEntity> GetAll(int limit, string searchstring)
        {
            ...
            return new ApiRequest().Execute<List<FileFolderEntity>>(_request);
        }
        ...
        public FileFolderEntity Get(int id)
        {
            ...
            return new ApiRequest().Execute<FileFolderEntity>(_request);
        }
