...
namespace CloneDeploy_ApiCalls
{
    public class MunkiManifestTemplateAPI : BaseAPI
    {
        ...
        public List<MunkiManifestTemplateEntity> GetAll(int limit, string searchstring)
        {
            ...
            return new ApiRequest().Execute<List<MunkiManifestTemplateEntity>>(_request);
        }
        ...
        public MunkiManifestTemplateEntity Get(int id)
        {
            ...
            return new ApiRequest().Execute<MunkiManifestTemplateEntity>(_request);
        }
