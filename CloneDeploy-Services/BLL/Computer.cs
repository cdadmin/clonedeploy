...
namespace CloneDeploy_App.BLL
{
    ...
    {
        public static ActionResultEntity AddComputer(ComputerEntity computer)
        {
        ...
        public static ActionResultEntity DeleteComputer(int id)
        {
        ...
        public static DistributionPointEntity GetDistributionPoint(ComputerEntity computer)
        {
        ...
        public static ComputerEntity GetComputer(int computerId)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static ComputerEntity GetComputerFromMac(string mac)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static List<ComputerEntity> SearchComputersForUser(int userId, int limit, string searchString = "")
        {
        ...
        public static List<ComputerEntity> GetAll()
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static List<ComputerEntity> SearchComputers(string searchString, int limit)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static ActionResultEntity UpdateComputer(ComputerEntity computer)
        {
        ...
        public static IEnumerable<ComputerEntity> ComputersWithCustomBootMenu()
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static List<ComputerEntity> ComputersWithoutGroup(string searchString, int limit)
        {
        ...
        public static ActionResultEntity ValidateComputer(ComputerEntity computer, string type)
        {
