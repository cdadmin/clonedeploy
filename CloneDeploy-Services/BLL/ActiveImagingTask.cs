...
namespace CloneDeploy_App.BLL
{
    ...
    public class ActiveImagingTask
    {
        ...
        public static ActionResultEntity DeleteActiveImagingTask(int activeImagingTaskId)
        {
            var actionResult = new ActionResultEntity() { Success = false };
            using (var uow = new UnitOfWork())
            {
        ...
        public static void SendTaskCompletedEmail(ActiveImagingTaskEntity task)
        {
            //Mail not enabled
        ...
        public static void SendTaskErrorEmail(ActiveImagingTaskEntity task, string error)
        {
            //Mail not enabled
            if (Settings.SmtpEnabled == "0") return;
            task.Computer = BLL.Computer.GetComputer(task.ComputerId);
        ...
        public static bool AddActiveImagingTask(ActiveImagingTaskEntity activeImagingTask)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static bool UpdateActiveImagingTask(ActiveImagingTaskEntity activeImagingTask)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static List<ActiveImagingTaskEntity> MulticastMemberStatus(int multicastId)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static List<ActiveImagingTaskEntity> MulticastProgress(int multicastId)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static List<ActiveImagingTaskEntity> ReadAll(int userId)
        {
        ...
        public static List<ActiveImagingTaskEntity> ReadUnicasts(int userId, string taskType)
        {
            using (var uow = new UnitOfWork())
            {
                //Admins see all tasks
        ...
        public static List<ComputerEntity> GetMulticastComputers(int multicastId)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static ActiveImagingTaskEntity GetTaskForComputer(int computerId)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static ActiveImagingTaskEntity GetTask(int taskId)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static ActiveImagingTaskEntity GetLastQueuedTask(string qType)
        {
            using (var uow = new UnitOfWork())
            {
                return
        ...
        public static ActiveImagingTaskEntity GetNextComputerInQueue(string qType)
        {
            using (var uow = new UnitOfWork())
            {
                return
