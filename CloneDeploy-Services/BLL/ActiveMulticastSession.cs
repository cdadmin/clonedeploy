...
namespace CloneDeploy_App.BLL
{
    public class ActiveMulticastSession
    {
        ...
        public static bool AddActiveMulticastSession(ActiveMulticastSessionEntity activeMulticastSession)
        {
        ...
        public static void SendMulticastCompletedEmail(ActiveMulticastSessionEntity session)
        {
            //Mail not enabled
        ...
        public static ActiveMulticastSessionEntity GetFromPort(int port)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static ActionResultEntity Delete(int multicastId)
        {
        ...
        public static ActiveMulticastSessionEntity Get(int multicastId)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static List<ActiveMulticastSessionEntity> GetOnDemandList()
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static bool UpdateActiveMulticastSession(ActiveMulticastSessionEntity activeMulticastSession)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static List<ActiveMulticastSessionEntity> GetAllMulticastSessions(int userId)
        {
            using (var uow = new UnitOfWork())
            {
