...
namespace CloneDeploy_App.BLL
{
    ...
    {
        public static void AddGroupProperty(GroupPropertyEntity groupProperty)
        {
        ...
        public static GroupPropertyEntity GetGroupProperty(int groupId)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static void UpdateGroupProperty(GroupPropertyEntity groupProperty)
        {
            using (var uow = new UnitOfWork())
            {
        ...
        public static void UpdateComputerProperties(GroupPropertyEntity groupProperty)
        {
