...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
   ...
   <p>Boot Menu Templates and Boot Menu Entries are lumped together in this section.  Boot Menu Templates and Entries are only used with the Linux Imaging Environment.  The difference b/w the two is that Boot Menu Templates allow you create a completely customized boot menu
       ...
       you generate the Global Default Boot Menu.  They do not get inserted when you create the entry, only after you generate the new boot files in Admin->Boot Menu</p>
