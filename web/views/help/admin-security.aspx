...
<asp:Content ID="Content1" ContentPlaceHolderID="subcontent" Runat="Server">
   ...
   <h3>Require Image Approval</h3>
    ...
    <p>If you plan on authenticating users via LDAP or LDAP groups, you must first setup LDAP here.  This currently only works when CloneDeploy is installed on Windows and has only been tested when
